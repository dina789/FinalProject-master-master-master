    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageheart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent gotofav = new Intent(search.this, Favorite_Activity.class);
        ...
        imagepower.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                editor.commit();
                //   finish();
                Intent gotosignin = new Intent(search.this, SignIn_Activity.class);
        ...
        edit_search.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                search.GetPlacesFormatAPI getPlacesFormatAPI = new search.GetPlacesFormatAPI();
...
//                executeWebService(url);
        ...
        protected void onPostExecute(final placemodel[] PlaceModels) {
            ...
            if (PlaceModels != null) {
                ...
                Place_adapter PlaceAdapter = new Place_adapter(search.this, PlaceModels);
